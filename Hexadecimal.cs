...
namespace NumeralSystems
{
    class Hexadecimal
    {
        ...
        public object Decimal { get; private set; }
        ...
        public void ShowResults()
        {
           ...
           // Decimal decimal = new Decimal(result.ToString());
            //Console.WriteLine(decimal.DecimalToBinary());
           // Console.WriteLine(decimal.DecimalToOctal());
        }
    }
}
